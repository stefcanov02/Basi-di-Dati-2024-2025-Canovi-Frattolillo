...
\subsection{Dizionario dei dati}
 ...
 \begin{table}[h!]
    ...
    \hline
    APPLICAZONE TECNOLOGICA & Prodotto software o hardware & Tecnologia, Tipo piattaforma & ID prodotto \\
    \hline
    SISTEMA FISICO & Prodotto fisico & Funzionalità, Durata vita & ID prodotto \\
    \hline
    SERVIZIO & Prodotto intangibile & Piano tariffario, Supporto tecnico & ID prodotto \\
    \hline
...
\begin{table}[h!]
    ...
    \hline
    FORNISCE & Rappresenta un cittadino attivo che propone un'idea & CITTADINO ATTIVO (1,N), IDEA (1,1) & - \\
    \hline
